...
整套方案经过精心剪枝与优化，**砍掉了昂贵臃肿的外部高价视觉板**，采用高性价比的 SG90 舵机后，将总预算进一步压缩至 **180 - 200 元（人民币）左右**：
...
| **耳朵** | 数字麦克风 | INMP441 I2S 全向采集模块 | 1 | 10 元 |
| **嘴巴** | 数字功放 | MAX98357A I2S 功放模块 | 1 | 8 元 |
| **声音发声** | 腔体喇叭 | 8Ω 2W 密封小音腔喇叭 (2030/1520) | 1 | 9 元 |
| **情绪屏幕** | OLED 屏 | 0.96 寸 SSD1306 (4Pin I2C 接口) | 1 | 9 元 |
| **机械动力** | 微型舵机 | SG90 9g 微型舵机 (塑料/尼龙齿) | 4 | 18 元 |
| **骨架结构** | 3D打印件 | 米士古开源腿 STL (高韧性树脂/PLA) | 1套 | 35 元 |
| **稳固供电** | 大电流升压板 | 5V 3.5A 同步升压一体板 (FP6276) | 1 | 12 元 |
| **动力源** | 动力锂电池 | 3.7V 2500mAh 动力锂电 (带保护板) | 1 | 18 元 |
